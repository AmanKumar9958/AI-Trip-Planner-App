...
const auth = () => {
  ...
  return (
    <View className="flex-1 bg-blue-100 items-center justify-start rounded-2xl overflow-hidden">
      {/* Gradient Header */}
      <View className="w-full h-[45%] bg-gradient-to-b from-orange-300 to-orange-500 rounded-t-2xl justify-center items-center">
        <Image
      ...
      {/* Content */}
      <View className="flex-1 w-full bg-white -mt-10 rounded-t-3xl shadow-2xl items-center pt-10">
        <Text
          className="text-black text-4xl font-bold mb-12 text-center"
          numberOfLines={1}
        >
